...
import com.example.mixmate.databinding.FragmentIngredientBinding
...
class IngredientListRecyclerViewAdapter(
...
) : RecyclerView.Adapter<IngredientListRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(binding: FragmentIngredientBinding) :
